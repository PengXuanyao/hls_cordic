...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "myarctan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myarctan_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.xi_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.yi_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flag_delay_a_V_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	cordic {
		full_alpha {Type I LastRead 0 FirstWrite -1}
		sin_out {Type O LastRead -1 FirstWrite 3}
		cos_out {Type O LastRead -1 FirstWrite 3}
		myarctan {Type I LastRead -1 FirstWrite -1}}}
