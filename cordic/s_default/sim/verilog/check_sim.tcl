...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cordic.autotvin_full_alpha.dat"
         "c.cordic.autotvout_sin_out.dat"
         "c.cordic.autotvout_cos_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cordic.autotvout_sin_out.dat"
         "rtl.cordic.autotvout_cos_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
