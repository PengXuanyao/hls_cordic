...
# 56 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_fixed.h" 2
...
# 56 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_int.h"
...
typedef ap_fixed<17, 17 -14> di_t;
typedef ap_fixed<16, 16 -14> do_t;
typedef ap_uint<2> flag_t;

const di_t PI = 3.1415926;
const do_t Kn = 0.607252935;

__attribute__((sdx_kernel("cordic", 0))) void cordic(di_t alpha, do_t &mysin, do_t &mycos);
# 8 "src/cordic.cpp" 2
# 17 "src/cordic.cpp"
...
# 124 "src/cordic.cpp"
__attribute__((sdx_kernel("cordic", 0))) void cordic (di_t full_alpha, do_t &sin_out, do_t &cos_out)
{
#pragma HLS TOP name=cordic
# 125 "src/cordic.cpp"
